...
<p>Image forensic technologies can be categorized as active ones and passive ones.</p>
<p>Active image forensic methods mainly insert digital watermark to images/videos at the instant of their acquisition. The integrity of images/videos can be checked by detecting the change in the watermark. In contrast, passive image forensic aims at developing technologies for tampered image/video detection without using knowledge beyond the image/video itself.</p>
<br>
