...
% Q1 = 50;
% Q2 = 95;
% Intiazling AUC as zero depending on how many images have to be studied
AUC = zeros(6);
x1 = 1;
y1 = 1;
...
for Q1=50:10:100
    ...
    for Q2=50:10:100
        ...
        % figure;
         pfa_avg = pfa_avg/20;% average pfa value is calculated for the 20 images
         pd_avg = pd_avg/20;% average pd value is calculated for the 20 images
        % plot (pfa_avg,pd_avg);
        
        AUC (x1,y1) = trapz(flip(pfa_avg),flip(pd_avg));% we now obtain the Area under ROC curve for the QF1=x and QF2=y
        x1 = x1+1;
    end
    y1 = y1+1;
end
